  ...
  public: {
    Tables: {
      ...
      host_rate_change_audit: {
        ...
        Relationships: [
          {
            foreignKeyName: "host_rate_change_audit_host_id_fkey"
            columns: ["host_id"]
            isOneToOne: false
      ...
      hosts: {
        Row: {
          ...
          state: string | null
          status: Database["public"]["Enums"]["host_status_enum"]
          updated_at: string
          user_id: string
          verification_status:
        ...
        Relationships: [
          {
            foreignKeyName: "hosts_application_id_fkey"
    ...
    Enums: {
      host_status_enum: "active" | "inactive" | "banned" | "pending"

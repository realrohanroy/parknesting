...
const Auth: React.FC = () => {
  ...
  const renderVerificationMessage = () => (
    <div className="bg-green-50 border border-green-100 rounded-lg p-6 text-center mb-8">
      ...
      <h2 className="text-xl font-semibold text-green-800 mb-2">Verification Email Sent</h2>
      <p className="text-green-700 mb-4">
        We've sent a verification link to <strong>{email}</strong>. 
        Please check your inbox and click the link to verify your account.
      </p>
      <p className="text-sm text-green-600 mb-6">
        If you don't see the email, please check your spam folder or try the options below:
      </p>
      <div className="space-y-4">
        <Button
          ...
          onClick={() => {
            // You would implement resend verification here
            toast({
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={cn(
                                "w-full pl-10 pr-10 py-2.5 rounded-lg border focus:ring focus:ring-opacity-50 transition-all",
                                password && confirmPassword && password !== confirmPassword 
                                  ? "border-red-300 focus:border-red-400 focus:ring-red-200"
                                  : "border-gray-300 focus:border-parkongo-400 focus:ring-parkongo-200"
                              )}
